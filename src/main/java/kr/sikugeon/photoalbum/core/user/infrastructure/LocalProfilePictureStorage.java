...
import kr.sikugeon.photoalbum.core.user.domain.FailedLoadingProfilePictureException;
import kr.sikugeon.photoalbum.core.user.domain.FailedSavingProfilePictureException;
